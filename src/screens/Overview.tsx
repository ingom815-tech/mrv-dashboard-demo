...
export default function Overview({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "flex flex-col gap-3" : "flex min-h-screen flex-col gap-3 px-4 py-3 md:px-6 md:py-4 xl:h-screen xl:min-h-0"}>
      {!embedded && (
        <>
          <header className="flex shrink-0 flex-wrap items-center justify-between gap-x-4 gap-y-2">
            <div className="flex min-w-0 items-center gap-2.5">
              <h1 className="text-[20px] leading-tight font-bold text-navy md:text-[24px]">2026년 상반기 감축성과</h1>
              <span
